...
struct seg_tree {
    ...
    seg_tree() {}
    seg_tree(int sz, long long element = 0) {
        n = sz;
        t.resize(4 * n);
        lazy_add.resize(4 * n, null);
        lazy_assign.resize(4 * n, null);
        vector<long long> a(n, element);
        build(a);
    }
    ...
    * whether this be updating lazy for that node or using its value for get(), sum(), or
    ...
    */
    ...
    void range_assign(int l, int r, long long new_val) {
        range_assign(l, r, new_val, 1, 0, n - 1);
    }
    void range_assign(int l, int r, long long new_val, int v, int tl, int tr) {
        propagate(v, tl, tr);
    ...
    void range_add(int l, int r, long long added_val) {
        range_add(l, r, added_val, 1, 0, n - 1);
    }
    void range_add(int l, int r, long long added_val, int v, int tl, int tr) {
        propagate(v, tl, tr);
